...
public class ResponseGoodActivitiesFragment extends Fragment{

private String TAG = "ResponseGoodActivitiesFragment";
	...
	public static ResponseGoodActivitiesFragment newInstance(Map<String,String> responseMap) {
        ResponseGoodActivitiesFragment fragmentDemo = new ResponseGoodActivitiesFragment();
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		...
		view = inflater.inflate(R.layout.response_good_activities_fragment, container, false);
		responseMap = (Map<String, String>) getArguments().getSerializable("responseMap");	
		BarChart mBarChart = (BarChart) view.findViewById(R.id.ResponseGoodActivitiesBarchart);
		int counter = 0;
